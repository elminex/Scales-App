    ...
    <>
      <form className="form">
        <div className="form__type-wrapper">
          <label className={`${sharpsSelected ? 'form__input-label-acc sharp selected' : 'form__input-label-acc sharp'}`} htmlFor="SharpsOnly"><Sharp />
          ...
          <label className={`${flatsSelected ? 'form__input-label-acc flat selected' : 'form__input-label-acc flat'}`} htmlFor="FlatsOnly"><Flat />
